    ...
    return (
        <div className="h-[calc(100vh-72px)]">
            <div className="flex items-center justify-center px-4 sm:px-6 lg:px-12">
                ...
                >
                    {/* Left: Intro Text */}
                    <div className="relative flex-1 space-y-6 gradient-border rounded-lg">
                        <div className="gradient-border-content">
                            ...
                            <div className="hover:animate-rotate absolute -bottom-5 left-1/2 -translate-x-1/2 flex items-center gap-3 z-50 bg-gradient-to-r from-purple-400 via-fuchsia-500 to-pink-500 p-2 rounded-full shadow-lg">

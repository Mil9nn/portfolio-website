...
const Background = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-zinc-900 via-zinc-950 to-black text-white py-12">
      ...
      <section ref={educationSection.ref} className="container mx-auto px-6 md:px-12 mb-16">
        <div className="border-l-4 border-blue-500 pl-6">
          ...
          <div className="mb-3">
            ...
            <p className="text-sm text-gray-400 mb-1">University of Jammu</p>
      ...
      <section ref={experienceSection.ref} className="container mx-auto px-6 md:px-12 mb-16">
        <div className="border-l-4 border-green-500 pl-6">
          ...
          <div className="mb-3">
            ...
            <p className="text-sm text-gray-400 mb-1">Prodigy Infotech</p>

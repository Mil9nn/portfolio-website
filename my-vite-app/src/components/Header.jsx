      ...
      <div className="container mx-auto py-4 px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <h1 className={`${isScrolled ? 'text-white' : 'text-gray-900'} text-2xl font-extrabold transition-colors duration-300`}>Milan Singh</h1>
          </div>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-6">
            <a href="https://github.com/Mil9nn" className={`${isScrolled ? 'text-white hover:text-yellow-300' : 'text-blue-700 hover:text-purple-700'} font-bold py-2 px-4 rounded-lg hover:underline transition-all duration-300 cursor-pointer`}>
              View my Work
            </a>
          ...
          {/* Mobile Menu Button */}
          <button
            className={`md:hidden ${isScrolled ? 'text-white' : 'text-blue-700'} transition-colors duration-300`}
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 pt-4 border-t border-amber-400/30 mt-3 animate-fadeDown">
            <div className="flex flex-col space-y-3">
              <a href="https://github.com/Mil9nn" className="text-blue-700 font-bold py-3 px-4 rounded-lg hover:bg-amber-200/80 transition-all text-left">
                View my Work
              </a>

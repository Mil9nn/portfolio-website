...
function Main() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-100">
            ...
            <div className={`container mx-auto px-4 md:px-8 lg:px-12 mt-20 transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 bg-white dark:bg-gray-800 backdrop-blur-sm p-6 rounded-xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                    {/* Background Section */}
                    <div className="mb-8 md:mb-0 flex-1">
                        <h4 className="text-xl font-semibold mb-4 text-purple-500 dark:text-purple-400">Background</h4>
                ...
                {/* Education Section */}
                <div className="my-12 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                    <h4 className="text-xl font-semibold mb-6 text-blue-500 dark:text-blue-400">Education</h4>
                    <div className="border-l-2 border-blue-500 pl-6 py-2">
                        <h5 className="text-xl font-semibold mb-1 text-gray-800 dark:text-white">Bachelor of Engineering</h5>
                        <p className="text-purple-500 dark:text-purple-400 mb-2">University of Jammu • 2019-2023</p>
                    </div>
                </div>

                {/* Experience Section */}
                <div className="mb-12 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                    <h4 className="text-xl font-semibold mb-6 text-green-500 dark:text-green-400">Experience</h4>
                    <div className="border-l-2 border-green-500 pl-6 py-2">
                        <h5 className="text-xl font-semibold mb-1 text-gray-800 dark:text-white">Web Development Intern</h5>
                        <p className="text-green-500 dark:text-green-400 mb-3">Prodigy Infotech • 15th March 2025 - Present</p>

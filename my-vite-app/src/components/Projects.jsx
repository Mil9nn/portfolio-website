...
function Projects() {
    ...
    const projects = [
        ...
        },
        {
            ...
            name: "Take Notes",
            image: "",
            description: "A simple note taking application where users can create, edit or delete notes, mark the tasks as completed, and more",
            technologies: ["React"],
                    ...
                    <div key={project.id} className="group perspective w-full max-w-[320px] mx-auto">
                        <div className="relative w-full h-72 transition-transform duration-700 transform-style-preserve-3d group-hover:rotate-y-180">
                            ...
                            <div className={`absolute w-full h-[250px] backface-hidden ${lightMode ? "bg-zinc-200 border-zinc-300" : "bg-zinc-800 border-zinc-700"} rounded-md shadow-lg border flex flex-col justify-center items-center text-center`}>
                                ...
                                <h3 className={`text-lg font-semibold ${lightMode ? "text-black" : "text-white"}`}>{project.name}</h3>
                            </div>

                            {/* Back */}
                            <div className={`absolute w-[320px] h-[250px] backface-hidden rotate-y-180 rounded-xl shadow-lg border p-4 flex flex-col justify-between ${lightMode ? "bg-zinc-200 border-zinc-300" : "bg-zinc-800 border-zinc-700"}`}>
                                <p className={`text-sm ${lightMode ? "text-gray-800" : "text-gray-300"} line-clamp-6 mb-4`}>{project.description}</p>
                                ...
                                <div className="flex justify-center gap-3">
                                    <a href={project.github} target="_blank" rel="noopener noreferrer"
                                        className="p-2 bg-zinc-400 hover:bg-zinc-500 rounded-full transition">
